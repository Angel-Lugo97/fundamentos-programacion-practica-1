...
function miInformacion() {
  ...
  const nombre = "Angel Abraham Lugo Saenz";
  const edad = 28;
  const carrera = "TSU desarrollo de software";
...
function areaRectangulo(base, altura) {
  // TODO: Calcula y retorna el Ã¡rea (base * altura)git
...
function celsiusAFahrenheit(celsius) {
  ...
  //Formula aplicada a codigo de Celsius a Fahrenheit
...
function mayorDeTres(a, b, c) {
  ...
  //Usamos Math.max para retonar el valor mas alto de los numeros ingresados 
...
function filtrarMayores(numeros, limite) {
  ...
  //Utilizamos el bucle for..of para recorrer directamente los valores del array numeros, sin necesidad de declarar un indice(i)
  //si el numero es mayor a limite, se agrega al array mayores
  const mayores = [];
